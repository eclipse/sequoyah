...
public class DeviceTypeCustomWizardPageHandler {
	...
	private static ArrayList<IDeviceTypeCustomWizardPage> getSuperClassWizardPages(
			String deviceTypeId) {
		ArrayList<IDeviceTypeCustomWizardPage> existPages = customPages
				.get(deviceTypeId);
		ArrayList<IDeviceTypeCustomWizardPage> pages = new ArrayList<IDeviceTypeCustomWizardPage>();
		IDeviceType currentDeviceType = DeviceTypeRegistry.getInstance()
		...
		if (currentDeviceType != null) {
			...
			if (superClassDeviceTypeId != null) {
				pages.addAll(0,
						getSuperClassWizardPages(superClassDeviceTypeId));
				ArrayList<IDeviceTypeCustomWizardPage> superPages = customPages
