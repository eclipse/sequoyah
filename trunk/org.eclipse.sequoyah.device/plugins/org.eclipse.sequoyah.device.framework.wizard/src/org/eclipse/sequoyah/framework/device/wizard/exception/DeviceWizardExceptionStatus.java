...
public class DeviceWizardExceptionStatus extends AbstractExceptionStatus {
	...
	public ExceptionMessage getEmulatorMessage(int code) {
		...
		switch (code) {
			case CODE_ERROR_RESOURCE_NOT_AVAILABLE: message = new ExceptionMessage(IStatus.ERROR,DeviceWizardResources.TML_Resource_Not_Available);break;			
			case CODE_ERROR_HANDLER_NOT_INSTANCED: message = new ExceptionMessage(IStatus.ERROR,DeviceWizardResources.TML_Handler_Not_Instanced);break;
			default: message = new ExceptionMessage(IStatus.ERROR,DeviceWizardResources.TML_Error); break;		        
		}			
		return message;
	}
