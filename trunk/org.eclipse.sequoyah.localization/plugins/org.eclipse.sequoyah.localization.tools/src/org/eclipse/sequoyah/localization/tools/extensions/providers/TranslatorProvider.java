...
public class TranslatorProvider
{
    ...
    public ITranslator getTranslatorByName(String name)
    {
        ...
        /*
         * If the translators have already been loaded, use them
        ...
        /*
         * Check if there are translators defined and search for the 
         * one with the name passed as a parameter
         */
