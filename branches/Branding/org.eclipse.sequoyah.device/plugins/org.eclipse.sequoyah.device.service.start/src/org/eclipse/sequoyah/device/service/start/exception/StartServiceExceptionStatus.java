...
public class StartServiceExceptionStatus extends AbstractExceptionStatus {
	...
	public ExceptionMessage getEmulatorMessage(int code) {
		...
		switch (code) {
			case CODE_ERROR_RESOURCE_NOT_AVAILABLE: message = new ExceptionMessage(IStatus.ERROR,StartServiceResources.SEQUOYAH_Resource_Not_Available);break;			
			default: message = new ExceptionMessage(IStatus.ERROR,StartServiceResources.SEQUOYAH_Error); break;		        
		}			
		return message;
	}
