...
public class DeviceUIExceptionHandler extends ExceptionHandler {
	...
	public static SequoyahException exception(IStatus status) {
		return new SequoyahException(new DeviceUIExceptionStatus(status));
	}
	
	public static SequoyahException exception(int severity, int code, String message, Throwable exception) {
		return new SequoyahException(new DeviceUIExceptionStatus(severity, DeviceUIPlugin.PLUGIN_ID, code, message, exception));
	}

	public static SequoyahException exception(int code){
		return new SequoyahException(new DeviceUIExceptionStatus(code,DeviceUIPlugin.PLUGIN_ID,null,null));
	}

	public static SequoyahException exception(int code,Throwable exception) {
		return new SequoyahException(new DeviceUIExceptionStatus(code,DeviceUIPlugin.PLUGIN_ID,exception));
	}
	
	public static SequoyahException exception(int code,Object[] args,Throwable exception) {
		return new SequoyahException(new DeviceUIExceptionStatus(code,DeviceUIPlugin.PLUGIN_ID,args,exception));		
	}
