...
public class MetadataGeneratorDialog extends TitleAreaDialog {
    ...
    protected Control createDialogArea(Composite parent) {
        ...
        locLabel
                .setText(Messages.MetadataGeneratorDialog_RepositoryLocationLabel);
        ...
        GridData gdViewerComp = new GridData(GridData.FILL_BOTH
                | GridData.GRAB_HORIZONTAL);
        viewerComposite.setLayoutData(gdViewerComp);

        viewer = new ListViewer(viewerComposite, SWT.SINGLE | SWT.BORDER
        ...
        buttonsComposite.setLayoutData(new GridData(SWT.LEFT, SWT.FILL, false,
                false));
    ...
    private void getRepositoryLocation() {
        if (isDirtyRepository()) {
            boolean result = MessageDialog
                    .openQuestion(
                            getShell(),
                            Messages.MetadataGeneratorDialog_UnsavedRepositoryDialogTitle,
        ...
        directoryDialog
                .setMessage(Messages.MetadataGeneratorDialog_ChooseLocationDialogMessage);
    ...
    protected void createButtonsForButtonBar(Composite parent) {
        saveButton = createButton(parent, IDialogConstants.OK_ID,
                Messages.MetadataGeneratorDialog_SaveButton, true);
        setSaveButtonEnabledState();
    ...
    protected void okPressed() {
        ...
        try {
            ...
            GeneratorEngine.saveRespository(repository.getRepoLocation(),
                    repository);
        } catch (Exception x) {
            Activator
                    .logError(
                            Messages.MetadataGeneratorDialog_SaveRepositoryErrorMessage,
                            x);
        }
        super.okPressed();
    }
