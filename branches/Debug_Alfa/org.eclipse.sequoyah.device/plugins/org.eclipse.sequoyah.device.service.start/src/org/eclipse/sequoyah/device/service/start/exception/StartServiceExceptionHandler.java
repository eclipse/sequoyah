...
public class StartServiceExceptionHandler extends ExceptionHandler {
	...
	public static SequoyahException exception(IStatus status) {
		return new SequoyahException(new StartServiceExceptionStatus(status));
	}
	
	public static SequoyahException exception(int severity, int code, String message, Throwable exception) {
		return new SequoyahException(new StartServiceExceptionStatus(severity, StartServicePlugin.PLUGIN_ID, code, message, exception));
	}

	public static SequoyahException exception(int code){
		return new SequoyahException(new StartServiceExceptionStatus(code,StartServicePlugin.PLUGIN_ID,null,null));
	}

	public static SequoyahException exception(int code,Throwable exception) {
		return new SequoyahException(new StartServiceExceptionStatus(code,StartServicePlugin.PLUGIN_ID,exception));
	}
	
	public static SequoyahException exception(int code,Object[] args,Throwable exception) {
		return new SequoyahException(new StartServiceExceptionStatus(code,StartServicePlugin.PLUGIN_ID,args,exception));		
	}
