...
public class PreferencesManager
{
     ...
     */
    private Map<IProject, ProjectPreferencesManager> projectPreferencesManagers =
            new HashMap<IProject, ProjectPreferencesManager>();
    ...
    public ProjectPreferencesManager getProjectPreferencesManager(IProject project)
    {

        ProjectPreferencesManager projectPreferencesManager =
                projectPreferencesManagers.get(project);
