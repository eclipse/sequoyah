 ...
 * Matheus Tait Lima (Eldorado) - Adapting localization framework for automatic translations 
 ********************************************************************************/
...
public abstract class IStringEditorInput implements IEditorInput
{
     ...
     */
    public abstract boolean translateColumn(String srcColumnID, TranslationInfo newColumnInfo,
     ...
     * @return true if the translation was succefull
     */
    public abstract boolean translateCells(String srcColumnID, TranslationInfo[] newColumnInfo,
            IProgressMonitor monitor);
     ...
     * @throws SequoyahException
     */
    public abstract void setCellTooltip(String columnID, String key, String tooltip)
            throws SequoyahException;
