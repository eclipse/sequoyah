...
public class EditCellsOperation extends EditorOperation
{
     ...
     *            - the editor Object.
     */
    public EditCellsOperation(String label, String[] key, String[] column, CellInfo[] oldValue,
            CellInfo[] newValue, StringEditorPart editor)
    {
        super(label, editor);
        for (int i = 0; i < key.length; i++)
        {
            this.editCellOperations.add(new EditCellOperation(key[i], column[i], oldValue[i],
                    newValue[i], editor));
        }
    }
