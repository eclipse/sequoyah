...
import org.eclipse.sequoyah.tfm.sign.core.extension.permission.IPermissionGroupProvider;
...
public class PermissionGroupProvider extends ExtensionImpl implements
    ...
    public PermissionGroupProvider(IExtension extension) throws SignException {
        if (extension != null) {
            if (extension.getExtensionPointUniqueIdentifier().equals(
                    "org.eclipse.sequoyah.tfm.sign.core.securitypermission")) {
    ...
    /* (non-Javadoc)
     * @see org.eclipse.sequoyah.tfm.sign.core.extension.permission.IPermissionGroupProvider#getPermissionGroupByName(java.lang.String)
     */
    ...
    /* (non-Javadoc)
     * @see org.eclipse.sequoyah.tfm.sign.core.extension.permission.IPermissionGroupProvider#getPermissionGroupList()
     */
    ...
    /* (non-Javadoc)
     * @see org.eclipse.sequoyah.tfm.sign.core.extension.permission.IPermissionGroupProvider#getPermissionGroupListByPlatform(org.eclipse.sequoyah.tfm.sign.core.extension.Platform)
     */
    ...
    /* (non-Javadoc)
     * @see org.eclipse.sequoyah.tfm.sign.core.extension.permission.IPermissionGroupProvider#getPermissionGroupListSize()
     */
