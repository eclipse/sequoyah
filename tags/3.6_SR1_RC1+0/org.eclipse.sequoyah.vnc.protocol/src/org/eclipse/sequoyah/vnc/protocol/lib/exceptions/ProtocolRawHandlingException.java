...
public class ProtocolRawHandlingException extends ProtocolException {
	 ...
	 */
	public ProtocolRawHandlingException(String message) {
		super(message);
	}
	 ...
	 */
	public ProtocolRawHandlingException(Throwable cause) {
		super(cause);
	}
	 ...
	 *            The throwable that caused the exception to happen
	 */
	public ProtocolRawHandlingException(String message, Throwable cause) {
		super(message, cause);
	}
}
