...
public class QEmuARMDeviceExceptionStatus extends AbstractExceptionStatus {
	...
	public ExceptionMessage getEmulatorMessage(int code) {
		...
		switch (code) {
			case CODE_ERROR_RESOURCE_NOT_AVAILABLE: message = new ExceptionMessage(IStatus.ERROR,QEmuARMResources.SEQUOYAH_Resource_Not_Available);break;			
			default: message = new ExceptionMessage(IStatus.ERROR,QEmuARMResources.SEQUOYAH_Error); break;		        
		}			
		return message;
	}
